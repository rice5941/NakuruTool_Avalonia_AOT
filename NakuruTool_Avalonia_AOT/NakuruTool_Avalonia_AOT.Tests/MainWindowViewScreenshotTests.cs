...
public class MainWindowViewScreenshotTests
{
    ...
    public void CaptureMainWindowView_WithMapList()
    {
        ...
        var mockBeatmapGenerationPageViewModelA = new BeatmapGenerationPageViewModel(mockDatabaseServiceA, new MockBeatmapRateGenerator());
    ...
    public void CaptureMainWindowView_WithMapList_MenuCollapsed()
    {
        ...
        var mockBeatmapGenerationPageViewModelB = new BeatmapGenerationPageViewModel(mockDatabaseServiceB, new MockBeatmapRateGenerator());
    ...
    public void CaptureMainWindowView_LoadingOverlay()
    {
        ...
        var mockBeatmapGenerationPageViewModelC = new BeatmapGenerationPageViewModel(mockDatabaseServiceC, new MockBeatmapRateGenerator());
    ...
    public void CaptureMainWindowView_DifferentSizes(int width, int height, string sizeName)
    {
        ...
        var mockBeatmapGenerationPageViewModel3 = new BeatmapGenerationPageViewModel(mockDatabaseService3, new MockBeatmapRateGenerator());
